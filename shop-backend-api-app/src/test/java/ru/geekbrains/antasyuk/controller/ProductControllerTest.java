package ru.geekbrains.antasyuk.controller;
...
public class ProductControllerTest {
    ...
    public void testProductDetails() throws Exception {
        Category category = categoryRepository.save(new Category(null,"Category","some"));
        Product product = productRepository.save(new Product("Product",new BigDecimal(1234) , "Category", category));
